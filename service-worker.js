const CACHE_NAME = "parco-ex-velodromo-v6.3.12-release1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./campo.html",
  ...
  "./css/style.css?v=6.3.12release1",
  "./css/bar.css?v=6.3.12release1",
  "./css/info-struttura.css?v=6.3.12release1",
  "./js/config.js?v=6.3.12release1",
  "./js/weather.js?v=6.3.12release1",
  "./js/supabase-client.js?v=6.3.12release1",
  "./js/cliente.js?v=6.3.12release1",
  "./js/admin.js?v=6.3.12release1",
  "./js/bar.js?v=6.3.12release1",
  "./js/bar-admin.js?v=6.3.12release1",
  "./js/footer.js?v=6.3.12release1",
  "./js/pwa.js?v=6.3.12release1",
  "./js/push-notifications.js?v=6.3.12release1",
  "./js/update-manager.js?v=6.3.12",
  "./version.json",
  "./assets/gf-logo.png",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
